...
while True:
    try:
        ...
        with open(fr'C:\Users\ead\Documents\gomes\Nem 2 serie\logica programação\LogicaAulas\Aula05{nome_arquivo}.txt', 'w', encoding='utf-8') as f:
            f.write(novo_texto)
        ...
        with open(fr'C:\Users\ead\Documents\gomes\Nem 2 serie\logica programação\LogicaAulas\Aula05{nome_arquivo}.txt', 'a', encoding='utf-8') as f:
